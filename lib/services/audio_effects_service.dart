...
class AudioEffectsService {
  ...
  Future<EqualizerConfig?> equalizerConfig({
    ...
    try {
      ...
      debugPrint('[REIKO][audio-effects] Equalizer config failed: $error');
      return null;
  ...
  Future<bool> configureEqualizer({
    ...
    try {
      ...
      debugPrint('[REIKO][audio-effects] Equalizer failed: $error');
      return false;
    } on MissingPluginException {
      return false;
    }
  ...
  Future<bool> configureBassBoost({
    ...
    try {
      ...
      debugPrint('[REIKO][audio-effects] BassBoost failed: $error');
      return false;
    } on MissingPluginException {
      return false;
    }
  ...
  Future<bool> configureVolumeNormalization({
    ...
    try {
      ...
      debugPrint('[REIKO][audio-effects] VolumeNormalization failed: $error');
      return false;
    } on MissingPluginException {
      return false;
    }
